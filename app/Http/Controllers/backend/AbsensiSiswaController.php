...
class AbsensiSiswaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('absensi_siswa.show_class', ['kelas' => $absensi_siswa->kelas_id, 'tanggal' => $absensi_siswa->tanggal])->with('success', 'Absensi siswa berhasil diperbarui.');
    }
