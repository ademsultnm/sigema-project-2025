                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-1">
                                                        <a href="{{ route('e_learning.show', $item->id) }}" class="btn btn-info btn-sm" title="Detail"><i
                                                                class="bi bi-eye"></i></a>
                                                        <a href="{{ route('e_learning.edit', $item->id) }}" class="btn btn-warning btn-sm" title="Edit"><i
