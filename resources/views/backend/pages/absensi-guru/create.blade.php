                            ...
                            <table class="table table-hover table-bordered">
                                <thead class="table-light text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><button type="button" onclick="setAll('hadir')"
                                                class="btn btn-sm btn-outline-success">All Hadir</button></td>
                                        <td class="text-center"><button type="button" onclick="setAll('sakit')"
                                                class="btn btn-sm btn-outline-warning">All Sakit</button></td>
                                        <td class="text-center"><button type="button" onclick="setAll('izin')"
                                                class="btn btn-sm btn-outline-info">All Izin</button></td>
                                        <td class="text-center"><button type="button" onclick="setAll('alpha')"
                                                class="btn btn-sm btn-outline-danger">All Alpha</button></td>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input radio-hadir" type="radio" name="kehadiran[{{ $guru->id }}]"
                                                        value="hadir" checked>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input radio-sakit" type="radio" name="kehadiran[{{ $guru->id }}]"
                                                        value="sakit">
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input radio-izin" type="radio" name="kehadiran[{{ $guru->id }}]"
                                                        value="izin">
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input radio-alpha" type="radio" name="kehadiran[{{ $guru->id }}]"
                                                        value="alpha">
                                                </div>
                                            </td>
                                        </tr>
