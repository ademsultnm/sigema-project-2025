                ...
                <div class="table-responsive">
                    ...
                    <style>
                        ...
                        .table-excel th, .table-excel td {
                            border: 1px solid #c7c7c7; /* Garis grid */
                            padding: 8px 12px;
                        }
                        .table-excel thead th {
                            background-color: #f0f0f0; /* Warna header excel */
                            font-weight: bold;
                            text-align: center;
                        }
                        .table-excel tbody tr:hover {
                            background-color: #e6f7ff; /* Highlight row saat hover */
                        }
                        .cell-nilai {
                            text-align: center;
                            font-weight: bold;
                        ...
                        <tbody>
                            @forelse ($detailNilai as $data)
                                <tr>
                                    ...
                                    {{-- Mengambil kelas terakhir siswa saat data ini ada (Asumsi relasi many-to-many ambil latest, atau jika di tabel raport ada kelas_id, pakai itu) --}}
                                    <td class="text-center">
                                        {{-- Logika: Jika di raport ada kolom kelas, tampilkan. Jika tidak, ambil kelas siswa saat ini --}}
