                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                                    <div class="stats-icon red mb-2">
                                        <i class="bi bi-exclamation-circle-fil"></i>
                                    </div>
                                </div>
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted">Menampilkan data pembayaran dari
                                <strong>{{ \Carbon\Carbon::parse($startDate)->format('d M Y') }}</strong> sampai
                                <strong>{{ \Carbon\Carbon::parse($endDateDisplay)->format('d M Y') }}</strong>
                            </p>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 d-flex gap-2">
                                <a href="{{ route('laporan-keuangan.pdf', ['start_date' => $startDate, 'end_date' => $endDateDisplay]) }}"
                                    class="btn btn-danger" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i> Download PDF</a>
                            </div>
