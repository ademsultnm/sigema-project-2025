            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="text-subtitle text-muted">
                        Mata Pelajaran: <span
                            class="badge bg-light-primary text-primary">{{ $eLearning->mataPelajaran->nama ?? 'N/A' }}</span>
                    </p>
                </div>
                <div class="col-md-4 text-md-end">
                    <a href="{{ route('jawaban-siswa.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i>
                        Kembali</a>
                </div>
            </div>
        </div>
