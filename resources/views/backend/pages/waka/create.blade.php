...
@section('title', 'Tambah Waka Kurikulum')
@section('content')
    <div id="main">
        <header class="mb-3">
        ...
        <div class="page-heading">
            <h3>Tambah Waka Kurikulum Baru</h3>
        </div>
        <div class="page-content">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">Form Tambah Waka Kurikulum</div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form method="POST" action="{{ route('waka.store') }}">
                                @csrf
