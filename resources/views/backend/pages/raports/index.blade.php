                    ...
                    <form method="GET" action="{{ route('raports.index') }}" class="mb-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="nama_siswa" class="form-control" placeholder="Cari nama..."
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control" placeholder="Cth: 2025/2026"
